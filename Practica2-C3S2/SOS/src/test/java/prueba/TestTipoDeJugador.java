...
public class TestTipoDeJugador {
    ...
    public void testSeleccionJugadorAzulComputadoraRojoHumanoJuegoSimple() {
        ...
        assertTrue(((AutoJuegoSimple)juego.getTipoJuego()).getTipoJugador("Azul") == TipoJugador.COMPUTADORA);
        assertTrue(((AutoJuegoSimple)juego.getTipoJuego()).getTipoJugador("Rojo") == TipoJugador.HUMANO);
    }
    @Test
    public void testSeleccionJugadorAzulHumanoRojoComputadoraJuegoSimple() {
        ...
        assertTrue(((AutoJuegoSimple)juego.getTipoJuego()).getTipoJugador("Azul") == TipoJugador.HUMANO);
        assertTrue(((AutoJuegoSimple)juego.getTipoJuego()).getTipoJugador("Rojo") == TipoJugador.COMPUTADORA);
    }
    @Test
    ...
    public void testSeleccionJugadorAzulComputadoraRojoHumanoJuegoGeneral() {
        ...
        assertTrue(((AutoJuegoGeneral)juego.getTipoJuego()).getTipoJugador("Azul") == TipoJugador.COMPUTADORA);
        assertTrue(((AutoJuegoGeneral)juego.getTipoJuego()).getTipoJugador("Rojo") == TipoJugador.HUMANO);
    }
    @Test
    public void testSeleccionJugadorAzulHumanoRojoComputadoraJuegoGeneral() {
        ...
        assertTrue(((AutoJuegoGeneral)juego.getTipoJuego()).getTipoJugador("Azul") == TipoJugador.HUMANO);
        assertTrue(((AutoJuegoGeneral)juego.getTipoJuego()).getTipoJugador("Rojo") == TipoJugador.COMPUTADORA);
    }
    @Test
